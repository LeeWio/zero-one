...
const editorContainerVariants = tv({
  base: cn(
...
const editorVariants = tv({
  base: cn(
    ...
    '[&_[data-slate-placeholder]]:!top-1/2',
    '[&_[data-slate-placeholder]]:-translate-y-1/2',
    '[&_[data-slate-placeholder]]:text-muted-foreground/80',
